    ...
    public enum InternalMessage {
        ...
        ASM_WARNING(new HashMap<Language, String>() {{
           ...
           put(Language.KO,
            ...
            put(Language.HU, "DiscordSRV nem tudott csatlakozni a Discord-hoz. Oka:");
            ...
            put(Language.HU, "A robot nincsen fent egyetlen Discord-szerveren sem. Kövesd a telepítési utasításokat");
            ...
            put(Language.HU, "Egy szoba sem lett összekötve");
            ...
            put(Language.HU, "Se egy rendes szoba, se a konzolszoba nem lett összekötve. Követted a telepítési utasításokat?");
            ...
            put(Language.HU, "A konzolszoba egy olyan szoba amelyben csevegnek. Csak vakon bemásoltál egy azonosítót a beállításokba?");
            ...
            put(Language.HU, "A Vault nincs telepítve. Ez kell a zPermissions-höz való összeköttetéshez. Telepítsd a Vault-ot ha szeretnéd ezt használni.");
            ...
            put(Language.HU, "Hiba a konzolparancs lejegyzésében");
            ...
            put(Language.HU, "{player} halkan csatlakozott, azaz nem küldött egy belépési üzenetet");
            ...
            put(Language.HU, "{player} halkan lecsatlakozott, azaz nem küldött egy kilépési üzenetet");
            ...
            put(Language.HU, "Összekötött felhasználók nem lettek elmentve, mivel nem volt egy sem");
            ...
            put(Language.HU, "Összekötött felhasználók elmentve {ms}ms alatt");
            ...
            put(Language.HU, "Nem sikerült menteni az összekötött felhasználókat");
            ...
            put(Language.HU, "Statisztikák nem lettek elmentve, mivel nem volt egy sem");
            ...
            put(Language.HU, "Statisztikák elmentve {ms}ms alatt");
            ...
            put(Language.HU, "Nem sikerült elmenteni a statisztikákat");
            ...
            put(Language.HU, "Nem sikerült betölteni a plugin-t");
            ...
            put(Language.HU, "Nem sikerült a {rolename} azonosítóját megtalálni a csapatösszekötéshez. A robot a szerveren van?");
            ...
            put(Language.HU, "Érvénytelen kód, próbálkozz újra.");
            ...
            put(Language.HU, "Biztos vagy benne hogy az a kódod? Az összeköttetési kódok 4 számból állnak.");
            ...
            put(Language.HU, "Már össze vagy kötve a {username} ({uuid}) felhasználóval");
            ...
            put(Language.HU, "Nem állítottál szöveget a bejelentéshez");
            ...
            put(Language.HU, "Jelenleg képtelenek vagyunk összekötni a felhasználókat egy belső hiba miatt. Szólj a vezetőségnek.");
            ...
            put(Language.HU, "Nincsen engedélyed hogy megadd ezt a parancsot.");
            ...
            put(Language.HU, "Csak játékosok tudják ezt a parancsot végrehajtani.");
            ...
            put(Language.HU, "Az a parancs nem létezik.");
            ...
            put(Language.HU, "A DiscordSRV beállításai és nyelve újra lett töltve.");
            ...
            put(Language.HU, "A Minecraft-felhasználód sikeresen szétkapcsolva a {name} felhasználóval.");
            ...
            put(Language.HU, "A Minecraft-felhasználód nincs összekötve egy Discord-felhasználóval.");
            ...
            put(Language.HU, "A Minecraft-felhasználód mostantól össze van kötve a {name} felhasználóval.");
            ...
            put(Language.HU, "Nincs senki ezzel a Discord-azonosítóval/Discord-névvel/Minecraft-névvel/Minecraft-azonosítóval aki a \"{target}\" felhasználóval megyegyezik felkereséshez.");
            ...
            put(Language.HU, "Megpróbáltál küldeni egy üzenetet a játékbeli csevegőbe, de ehhez össze kell kötnöd a Minecraft-felhasználódat a Discord-felhasználódhoz. Játékon belül írd be hogy `/discord link`.\n```{message}```");
            ...
            put(Language.HU, "A Minecraft-felhasználód már össze van kötve egy Discord-felhasználóval. Ha van engedélyed hozzá, szétkapcsolhatod a /discord unlink paranccsal.");
            ...
            put(Language.EN, "Nem lett meghatározva játékos. Ez lehet UUID-vel (Minecraft-os azonosító), Minecraft-os névvel, és Discord-azonosítóval.");
        }});
